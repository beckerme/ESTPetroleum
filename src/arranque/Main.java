...
public class Main {
	...
	public static void main(String[] args) {
		...
		Posto posto16 = new Posto(16, 2700, 8500, 35000, "Shibuya", new Point (1162,850));
		Posto posto17 = new Posto(17, 1300, 22500, 27500, "Shinjuku", new Point (1062,410));
		Posto posto18 = new Posto(18, 1300, 10000, 50000, "Tokyo", new Point (745,567));
		Posto posto19 = new Posto(19, 2050, 5500, 30000, "Osaka", new Point (1212,612));
		Posto posto20 = new Posto(20, 1925, 5500, 32500, "Shinagawa", new Point (1180,340));
		...
		c.adicionarPosto(posto16);
		c.adicionarPosto(posto17);
		c.adicionarPosto(posto18);
		c.adicionarPosto(posto19);
		c.adicionarPosto(posto20);
		...
		Camiao camiao5 = new Camiao("MM-30-TS", 50000, 100, 50, new Itinerario(c.getPosicaoCentral())); // Feito pelo grupo

		c.adicionarCamiao(camiao1);
		c.adicionarCamiao(camiao2);
		c.adicionarCamiao(camiao3);
		c.adicionarCamiao(camiao4);
		c.adicionarCamiao(camiao5);
