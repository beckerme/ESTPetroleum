...
public class JanelaControlo extends JFrame {
	...
	private static final Stroke estiloLinhaExterior = new BasicStroke(5.0f, BasicStroke.CAP_ROUND,
			BasicStroke.JOIN_ROUND);
	private static final Stroke estiloLinhaInterior = new BasicStroke(2f, BasicStroke.CAP_ROUND,
			BasicStroke.JOIN_ROUND);
	...
	private void desenharPostos(Graphics2D g) {
		...
		// TODO ZFEITO para cada ponto desenhar uma linha entre esse e o anterior
	...
	private void botaoEsquerdoPremido(MouseEvent e) {
		...
		// NOTA: NÃO é preciso verificar se escreveu alguma coisa sem ser números (dá
		// erro, mas ...)
		...
		String msg = null;
		switch (r) {
			case Central.EXCEDE_CAPACIDADE_CAMIAO:
				msg = "Camião não tem capacidade";
				break;
			case Central.EXCEDE_CAPACIDADE_POSTO:
				msg = "Posto não tem capacidade";
				break;
			case Central.POSTO_NAO_PRECISA:
				msg = "Posto não tem necessidade";
				break;
			case Central.EXCEDE_TEMPO_TURNO:
				msg = "Turno longo demais";
				break;
		}
